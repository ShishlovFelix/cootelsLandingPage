        ...
        <Container maxWidth="lg" sx={{ display:'flex',
            ...
            <Grid container >
                <Grid item xs={6} sx={{ display:'block'}}>
                    ...
                    <Typography sx={{display:"flex", alignItems:'end',marginTop:'162px'}}>
                        <a style={{
                            color:"#424F7B",
                            fontFamily: 'Inter',
                            fontWeight:400,
                    ...
                    <Typography sx={{display:"flex", alignItems:'center',marginTop:'32px',}}>
                    <button style={{
                ...
                <Grid item xs={6} sx={{
                    ...
                    <Accordion  sx={{marginTop:'80px'}}>
                        <AccordionSummary
                            expandIcon={<ExpandMoreIcon sx={{color:'#FF620A',backgroundColor:"#FFECE2", borderRadius:"99px"}} />}
                            aria-controls="panel1a-content"
                            id="panel1a-header"  sx={{height:'100px'}}
                        >
                            <Typography sx={{
                                fontFamily: 'Montserrat',
                                fontWeight: 600,
                                ...
                                lineHeight:"150%",
                                color: "#424F7B",
                            }}>1. Choose a room and date</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Typography sx={{
                                fontFamily: 'Inter',
                    ...
                    <Accordion sx={{marginTop:'24px'}}>
                        ...
                        >
                            <Typography sx={{
                                ...
                                lineHeight:"150%",
                                color: "#424F7B",
                            }}>2. Check for room availability</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Typography sx={{
                                fontFamily: 'Inter',
